...
for sra_id in sra_accession_number:
        samtools_cmd = "samtools sort /home/qgn1237/qgn1237/4_single_cell_SV_chimera/1_smooth_seq_95_sc_K562_SMRT/" + sra_id + "/" + sra_id + ".sam" + " -o /home/qgn1237/qgn1237/4_single_cell_SV_chimera/1_smooth_seq_95_sc_K562_SMRT/" + sra_id + "/" + sra_id + "_sort.bam" + " -@ 16"
